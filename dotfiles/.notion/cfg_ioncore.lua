...
defbindings("WScreen", {
    ...
    kpress(WEIMETA.."1", "WScreen.switch_nth(_, 0)"),
    kpress(WEIMETA.."2", "WScreen.switch_nth(_, 1)"),
    kpress(WEIMETA.."3", "WScreen.switch_nth(_, 2)"),
    kpress(WEIMETA.."4", "WScreen.switch_nth(_, 3)"),
    kpress(WEIMETA.."5", "WScreen.switch_nth(_, 4)"),
    kpress(WEIMETA.."6", "WScreen.switch_nth(_, 5)"),
    kpress(WEIMETA.."7", "WScreen.switch_nth(_, 6)"),
    kpress(WEIMETA.."8", "WScreen.switch_nth(_, 7)"),
    kpress(WEIMETA.."9", "WScreen.switch_nth(_, 8)"),
    kpress(WEIMETA.."0", "WScreen.switch_nth(_, 9)"),
...
--    kpress(META.."period", "WScreen.switch_next(_)"),
    ...
    kpress("Mod5+1", "ioncore.goto_nth_screen(0)"),
    kpress("Mod5+2", "ioncore.goto_nth_screen(1)"),
    ...
    kpress(ALTMETA.."M", "mod_query.query_menu(_, 'mainmenu', 'Main menu: ')"),
...
defbindings("WMPlex", {
  ...
  submap(SUBMAP, {
    ...
    kpress("C", "WRegion.rqclose_propagate(_, _sub)"),
...
defbindings("WMPlex.toplevel", {
    ...
    -- Get things from the clipboard server to the xclipboard
    kpress("Shift+1", "ioncore.exec_on(_, 'clipget.sh 1')"),
    kpress("Shift+2", "ioncore.exec_on(_, 'clipget.sh 2')"),
    kpress("Shift+3", "ioncore.exec_on(_, 'clipget.sh 3')"),
    kpress("Shift+4", "ioncore.exec_on(_, 'clipget.sh 4')"),
    kpress("Shift+5", "ioncore.exec_on(_, 'clipget.sh 5')"),

    -- Insert things from the xclipboard to the clipboard server 
    kpress("Mod4+Control+1", "ioncore.exec_on(_, 'clipset.sh 1')"),
    kpress("Mod4+Control+2", "ioncore.exec_on(_, 'clipset.sh 2')"),
    kpress("Mod4+Control+3", "ioncore.exec_on(_, 'clipset.sh 3')"),
    kpress("Mod4+Control+4", "ioncore.exec_on(_, 'clipset.sh 4')"),
    kpress("Mod4+Control+5", "ioncore.exec_on(_, 'clipset.sh 5')"),
...
--    kpress(ALTMETA.."G", "mod_query.query_gotoclient(_)"),

--    bdoc("Query for a client window to attach."),
--    kpress(ALTMETA.."A", "mod_query.query_attachclient(_)"),
})
...
defmenu("mainmenu", {
    ...
    menuentry("Lock screen",    "ioncore.exec_on(_, 'xlock -mode blank')"),
